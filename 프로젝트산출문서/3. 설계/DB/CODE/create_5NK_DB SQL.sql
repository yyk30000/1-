...
(
    `article_code`     INT UNSIGNED     NOT NULL    AUTO_INCREMENT COMMENT '게시판 코드', 
...
(
    `tip_code`      INT UNSIGNED     NOT NULL    AUTO_INCREMENT COMMENT '팁 코드', 
...
(
    `cmt_code`      INT UNSIGNED     NOT NULL    AUTO_INCREMENT COMMENT '댓글 코드', 
...
(
    `link_code`       INT UNSIGNED    NOT NULL    AUTO_INCREMENT COMMENT '링크 코드', 
